...
%
% --------------------------
% !!! NOTE!!! This is a locally stored version of the lvmLoadData.m (so
% that matlab seeks for this file first before searching the other paths)
% of the DATASETS release so that we can add some more locally stored
% datasets without messing around with the formal version. The extra
% datasets (under "locally stored") also have to be added in the DATASETS
% directory.
%--------------------------------
%
...
switch dataset
    ...
    case 'missa'
        load([baseDir 'video/miss-americaHD.mat']);
        lbls = [288 ;360];
    case 'horse'
