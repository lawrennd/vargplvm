...
\begin{center}
\subfigure[]{
	\includegraphics[width=0.4\textwidth]{images/supplMocapScalesRbf}
	\label{fig:suppMocap1}
}
\subfigure[]{
	\includegraphics[width=0.4\textwidth]{images/supplMocapScalesMatern}
...
\begin{center}
\subfigure[]{
	%\includegraphics[width=0.48\textwidth]{images/supplMocapBody23GpdsRbf}
	\includegraphics[width=0.48\textwidth]{images/supplMocapBody28GpdsMatern}
	\label{fig:suppMocap3}
}
\subfigure[]{
	\includegraphics[width=0.48\textwidth]{images/supplMocapLeg5GpdsMatern}
...
\begin{center}
\subfigure[]{
	\includegraphics[width=0.23\textwidth]{images/supplDogPredYts5}
	\label{fig:suppDog1}
}
\subfigure[]{
	\includegraphics[width=0.23\textwidth]{images/supplDogPredGpds5}
	\label{fig:suppDog2}
}
\subfigure[]{
	\includegraphics[width=0.23\textwidth]{images/supplDogPredYts6}
	\label{fig:suppDog3}
}
\subfigure[]{
	\includegraphics[width=0.23\textwidth]{images/supplDogPredGpds6}
	\label{fig:suppDog4}
}
\end{center}
\caption{\small{
Some more examples for the reconstruction achieved for the 'dog' dataset. $40\%$ of the test image's pixels (figures \subref{fig:suppDog1} and \subref{fig:suppDog3}) were presented  to the model, which was able to succesfully reconstruct them, as can be seen in \subref{fig:suppDog2} and \subref{fig:suppDog4}.
}
}
\label{fig:supplDog}
\end{figure}
